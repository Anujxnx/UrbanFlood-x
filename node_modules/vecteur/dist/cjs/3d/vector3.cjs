...
var utils = require('../helpers/utils.cjs');
...
class Vector3 {
  ...
  randomize(min, max) {
    ...
    this.x = utils.randomInRange(min.x, max.x);
    this.y = utils.randomInRange(min.y, max.y);
    this.z = utils.randomInRange(min.z, max.z);
    return this;
  }
  /**
   ...
   */
  lerpX(v, alpha) {
    this.x = utils.lerp(this.x, v.x, alpha);
    return this;
  }
  /**
   ...
   */
  lerpY(v, alpha) {
    this.y = utils.lerp(this.y, v.y, alpha);
    return this;
  }
  /**
   ...
   */
  lerpZ(v, alpha) {
    this.z = utils.lerp(this.z, v.z, alpha);
    return this;
  }
  /**
