...
// node_modules/vecteur/dist/esm/helpers/utils.js
var randomInRange = (min, max) => Math.random() * (max - min) + min;
var lerp = (a, b, n) => (1 - n) * a + n * b;
var clamp = (n, min, max) => Math.max(Math.min(n, max), min);

// node_modules/vecteur/dist/esm/2d/vector2.js
var Vector2 = class _Vector2 {
   ...
   */
  rotate(angle) {
    return this.rotateAround(new _Vector2(), angle);
  }
  /**
   ...
   */
  randomize(min, max) {
    min = min || new _Vector2(0, 0);
    max = max || new _Vector2(1, 1);
   ...
   */
  clamp(min, max) {
    if (typeof min === "number") min = new _Vector2(min, min);
    if (typeof max === "number") max = new _Vector2(max, max);
...
// node_modules/vecteur/dist/esm/2d/index.js
function vec2(x, y) {
  if (Array.isArray(x)) return new Vector2(x[0], x[1]);
  return new Vector2(x, y);
}

// node_modules/vecteur/dist/esm/3d/vector3.js
var Vector3 = class _Vector3 {
   ...
   */
  randomize(min, max) {
    min = min || new _Vector3(0, 0, 0);
    max = max || new _Vector3(1, 1, 1);
    this.x = randomInRange(min.x, max.x);
    this.y = randomInRange(min.y, max.y);
   ...
   */
  clamp(min, max) {
    if (typeof min === "number") min = new _Vector3().set(min);
    if (typeof max === "number") max = new _Vector3().set(max);
    this.x = clamp(this.x, min.x, max.x);
    this.y = clamp(this.y, min.y, max.y);
  ...
  static randomDirection() {
    return _Vector3.fromAngles(Math.random() * Math.PI * 2, Math.asin(Math.random() * 2 - 1));
  }
  *[Symbol.iterator]() {
    yield this.x;
    yield this.y;
...
// node_modules/vecteur/dist/esm/3d/index.js
function vec3(x, y, z) {
...
//# sourceMappingURL=vecteur.js.map
